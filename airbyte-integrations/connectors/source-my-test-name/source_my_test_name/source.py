...
class MyTestNameStream(HttpStream, ABC):
    """
...
class Customers(MyTestNameStream):
    """
...
class IncrementalMyTestNameStream(MyTestNameStream, ABC):
    """
...
class Employees(IncrementalMyTestNameStream):
    """
    TODO: Change class name to match the table/data source this stream corresponds to.
    """
...
# Source
class SourceMyTestName(AbstractSource):
