...
import pytest
from source_my_test_name.source import MyTestNameStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MyTestNameStream, "path", "v0/example_endpoint")
    mocker.patch.object(MyTestNameStream, "primary_key", "test_primary_key")
    mocker.patch.object(MyTestNameStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = MyTestNameStream()
