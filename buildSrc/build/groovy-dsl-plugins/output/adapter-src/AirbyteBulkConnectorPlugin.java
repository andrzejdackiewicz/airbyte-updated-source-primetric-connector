...
/**
 * Precompiled airbyte-bulk-connector script plugin.
 **/
public class AirbyteBulkConnectorPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AirbyteBulkConnector").asSubclass(BasicScript.class);
