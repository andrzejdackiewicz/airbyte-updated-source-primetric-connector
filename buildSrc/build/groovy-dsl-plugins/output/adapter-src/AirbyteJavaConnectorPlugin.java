...
/**
 * Precompiled airbyte-java-connector script plugin.
 **/
public class AirbyteJavaConnectorPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AirbyteJavaConnector").asSubclass(BasicScript.class);
